...
export async function POST(req: NextRequest) {
    try {
        ...
        {
            "works": "For Top, Bottom, and Layers (if any), write ONE concise phrase (max 4 words) highlighting what works well. Join with periods. Example: 'Great Top Fit. Perfect Jeans Length.'",
            "tweaks": "For Top, Bottom, and Layers (if any), write ONE concise phrase (max 4 words) suggesting an improvement. ALWAYS provide at least 2 tweaks, even if minor. Do NOT return 'None'. Example: 'Tuck in Shirt. Pants too long. Roll up sleeves.'",
